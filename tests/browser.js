...
await check('透明素材合成且工程内嵌资源', async () => {
  ...
  await engine.addAsset({ id:'role0-0',name:'陆地伙伴',src:'/assets/misc/sprites/role0-0.webp',category:'sticker' });
...
await check('动画帧、时长、变换随工程保存重开', async () => {
  const frames = ['/assets/animation/sprites/animation-0-f0.webp','/assets/animation/sprites/animation-0-f1.webp'];
