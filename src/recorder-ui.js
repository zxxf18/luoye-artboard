...
export function mountRecorder({engine,run,toast,getColor,getTitle}){
  ...
  action('record-export',async()=>toast(await deliverFile('我的绘画录像.luoyer','application/json',JSON.stringify(recorder.export()))));
