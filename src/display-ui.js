...
export function mountDisplay(){
  ...
  let selected='auto';try{const previous=Object.keys(localStorage).find(k=>k!=='luoye-ui-size'&&k.endsWith('-ui-size'));selected=localStorage.getItem('luoye-ui-size')||(previous&&localStorage.getItem(previous))||'auto';}catch{}
